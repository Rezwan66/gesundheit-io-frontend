...
const AdminDashboardPage = async () => {
  ...
  //^ If we did not need any interactivity with the data, we could use the following code to get the data directly from the tanstack without using the QueryClient hook, and displayed the data directly from the page component
